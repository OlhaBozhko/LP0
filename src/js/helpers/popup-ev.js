...
function initiate(cookies) {
  ...
  function createModalBody(breakpoint) {
    ...
    if (mobile) {
      ...
      var mobileStyles =
        ".ever-desktop{display: none}@media screen and (min-width: " +
        breakpoint +
        "px){.ever-mobile{display: none}.ever-desktop{display: block;}}";
